 ...
 */
const BROWSER_REGEX = '/Edge?\/1(49|5[01])\.0(\.\d+|)|Firefox\/(140\.0|15[2-7]\.0)(\.\d+|)|Chrom(ium|e)\/(109\.0|120\.0|145\.0|1(4[89]|5[0-4])\.0)(\.\d+|)|(Maci|X1{2}).+ Version\/(26\.[56]|27\.0)([,.]\d+|)( \(\w+\)|)( Mobile\/\w+|) Safari\/|Chrome.+OPR\/(127\.0|131\.0)\.\d+|(CPU[ +]OS|iPhone[ +]OS|CPU[ +]iPhone|CPU IPhone OS|CPU iPad OS)[ +]+(18[._][5-7]|26[._][56])([._]\d+|)|Opera Mini|Android:?[ /-]151(\.0|)(\.\d+|)|Mobile Safari.+OPR\/8(0\.){2}\d+|Android.+Firefox\/153\.0(\.\d+|)|Android.+Chrom(ium|e)\/151\.0(\.\d+|)|Android.+(UC? ?Browser|UCWEB|U3)[ /]?1(5\.){2}\d+|SamsungBrowser\/(29|30)\.0|Android.+MQ{2}Browser\/14(\.9|)(\.\d+|)|K[Aa][Ii]OS\/(2\.5|3\.[01])(\.\d+|)/';
